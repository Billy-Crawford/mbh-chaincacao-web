...
export default function LotDetail() {
  ...
  // ================================
  // ÉTAPE 1 — CONFIRMER LA RÉCEPTION
  // ================================
  const handleValider = async () => {
    ...
    try {
      ...
      alert("Réception confirmée ✅ — le lot est maintenant prêt à être envoyé au transformateur.");
  ...
  return (
    <div className="min-h-screen bg-[#f6f1e7] p-6">
      <div className="max-w-2xl mx-auto">
        ...
        {/* INFO FLUX */}
        <div className="mt-4 bg-blue-50 border border-blue-100 p-4 rounded-xl text-xs text-blue-700">
